...
character*20 :: option_stoch_entrain = ""
...
!character*20 :: option_stoch_entrain = "fixed"
...
namelist / mass_flux_nml / up_num, do_mf_micro, &
                           ...
                           option_stoch_entrain, ent_fixed, &
...
!print*,'n,k,ENTf,ENTi',n,k,ENTf_k4(k,n),ENTi(k,n)
      ...
      endif  ! end if of option_stoch_entrain 
...
!yhc write(6,*) 'qq1, harvest',harvest

t=t*harvest
if (t <= g) exit
end do
!yhc write(6,*) 'qq1, direct method, em',em

else      !    Use rejection method.
!yhc write(6,*) 'qq1, rejection method, em',em
